...
public class ExtentReportListenerV4 extends BaseTest implements IReporter {
	private ExtentReports extent;
	private ExtentHtmlReporter htmlReport;

	@Override
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		htmlReport = new ExtentHtmlReporter(System.getProperty("user.dir") + File.separator+ "extentReport"+ File.separator +"ExtentReportV4.html");
